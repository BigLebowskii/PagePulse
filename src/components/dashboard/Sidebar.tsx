...
export default function Sidebar({ plan, auditsUsed, auditsLimit, open, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed top-0 left-0 z-40 h-full w-64 bg-white border-r border-gray-200 flex flex-col transition-transform duration-300 lg:translate-x-0 ${
      ...
      >
        ...
        <div className="flex items-center gap-2 px-6 h-16 border-b border-gray-100">
          ...
          <span className="text-lg font-heading font-bold text-slate-900">PagePulse</span>
        </div>
        ...
        <div className="px-4 py-4 border-t border-gray-100">
          <div className="rounded-xl bg-gray-50 p-3">
            ...
            <p className="mt-1 text-sm font-semibold text-slate-900">
              {auditsUsed}/{auditsLimit} audits used
            </p>
